                ...
                if (order1) {
                    ...
                    if (order2) {
                        ...
                        if (sendmail === null || sendmail === void 0 ? void 0 : sendmail.status) {
                            ...
                            if (processlog) {
                                return res.status(http_status_1.default.CREATED).send({ success: true, message: "Your Form has subbmitted successfully", data: order1 });
                            }
                        }
                    }
                }
                    ...
                    if (getorderid) {
                        ...
                        if (getemail) {
                            ...
                            if (sendmail) {
                                ...
                                if (processlog) {
                                    return res.status(http_status_1.default.CREATED).send({ success: true, message: "Your consent is uploaded successfully", data: constantfile });
                                }
                            }
                        }
                    }
